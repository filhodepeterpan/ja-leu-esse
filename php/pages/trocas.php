            ...
            <?php foreach ($livrosCarrossel15 as $index => $livro): ?>
                ...
                <div class="c-card">
                    ...
                    <div class="c-info">
                        ...
                        <div class="btn-propor-troca"
                            data-index="<?php echo $index ?>"
                            data-id-usuario="<?php echo $livro['id_usuario'] ?>"
                            data-nome="<?php echo htmlspecialchars($livro['nm_livro']) ?>"
                            data-url="/sistema/ja-leu-esse/assets/img/examples/<?php echo $livro['img_livro'] ?>"
                            data-alt="<?php echo htmlspecialchars($livro['nm_livro']) ?>"
                            style="width: 32px; height: 32px; border-radius: 50%; background: #222222;
                ...
                <div class="seletor-grid">
                    <?php foreach ($meus_livros as $index => $livro): ?>
                        <div class="seletor-card"
                            ...
                            data-url="/sistema/ja-leu-esse/assets/img/examples/<?php echo $livro['img_livro'] ?>"
                            data-alt="<?php echo htmlspecialchars($livro['nm_livro']) ?>">
                            <img src="/sistema/ja-leu-esse/assets/img/examples/<?php echo $livro['img_livro'] ?>" width="100px">
...
<div class="feed-livros" id="feed-livros">
     ...
     <?php foreach ($livrosParaTroca as $l) {if (empty($l['img_livro'])) {
            continue;
        }
        ?>
        <div class="feed-card">
            <img src="/sistema/ja-leu-esse/assets/img/examples/<?php echo $l['img_livro'] ?>" class="feed-capa">

             <div class="feed-info">
                <h3><?php echo $l['nm_livro'] ?></h3>

                 <div class="feed-rodape">
                    <a href="perfil.php?id_perfil=<?php echo $l['id_usuario'] ?>"><?php echo $l['nm_usuario'] ?></a>

                    <div class="btn-propor-troca"
                        data-index="<?php echo $l['id_livro'] ?>"
                        data-id-usuario="<?php echo $l['id_usuario'] ?>"
                        data-nome="<?php echo $l['nm_livro'] ?>"
                        data-url="/sistema/ja-leu-esse/assets/img/examples/<?php echo $l['img_livro'] ?>"
